...
import DeleteAction from '@/actions/admin/blog/delete'
...
const DeletePost = ({ id }: DeleteSCProps) => {
    ...
    // 1. Define your form.
    const form = useForm<z.infer<typeof byIdSchema>>({
        resolver: zodResolver(byIdSchema),
        defaultValues: {
            id: id,
        },
    });
    ...
    function onSubmit(values: z.infer<typeof byIdSchema>) {
        setError("");
        setSuccess("");
