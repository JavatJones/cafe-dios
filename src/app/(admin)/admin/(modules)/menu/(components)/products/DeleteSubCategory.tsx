...
import DeleteProductAction from '@/actions/admin/menu/Products/delete'
...
const DeleteProduct = ({ id }: DeleteSCProps) => {
    ...
    function onSubmit(values: z.infer<typeof DeleteProductSchema>) {
        setError("");
        setSuccess("");

        startTransition(() => {
            DeleteProductAction(values)
                .then((data) => {
                    setError(data.error);
